/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2016/4/20 13:26:25
 * *******************************************************/
using System;
...
namespace Frxs.ServiceCenter.Api.Core.SdkBuilder.Actions
{
    ...
    public class ApiDocAction : ActionBase<ApiDocAction.ApiDocActionRequestDto, ApiDocAction.ApiDocActionResponseDto>
    {
        ...
        public override ActionResult<ApiDocActionResponseDto> Execute()
        {
            ...
            //上送的数据
            string requestDtoJson = this._apiDocBuilder.CreateInstance(actionDescriptor.RequestDtoType).SerializeObjectToJosn();
