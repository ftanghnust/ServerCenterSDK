...
{
    public class OrderSubmitRequestDto : RequestDtoParent
    {
        /// <summary>
        /// 门店订单
        /// </summary>
        public OrderRequestDto OrderShop { get; set; }
        ...
        /// 是否覆盖旧数据
        /// </summary>
        public bool bDeleteOld { get; set; }
    ...
    /// 订单信息
    /// </summary>
    public class OrderRequestDto : RequestDtoParent
    {
        #region 模型
        /// <summary>
        /// 订单编号
    ...
    /// 商品明细
    /// </summary>
    public class OrderDetailRequestDto : RequestDtoParent
    {
        #region 模型
        /// <summary>
        /// 编号(仓库ID+GUID)
    ...
    /// 商品明细扩展
    /// </summary>
    public class OrderDetailExtsRequestDto : RequestDtoParent
    {
