...
namespace Frxs.Erp.ServiceCenter.Promotion.Actions.ResponseDto
{
    ...
    /// 单个订单返回结果
    /// </summary>
    public class OrderShopResponseDto : ResponseDtoBase
    {
        #region 模型
        /// <summary>
        /// 订单编号
    ...
    /// 商品明细
    /// </summary>
    public class OrderDetailRequestDto : ResponseDtoBase
    {
    ...
    /// 商品明细扩展
    /// </summary>
    public class OrderDetailExtsRequestDto : ResponseDtoBase
    {
