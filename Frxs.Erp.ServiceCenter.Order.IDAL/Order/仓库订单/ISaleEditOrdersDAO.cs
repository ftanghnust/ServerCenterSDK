...
{
    /// <summary>
    /// ### SaleEditOrders数据库访问接口
    /// </summary>
    public partial interface ISaleEditOrdersDAO
    {
        ...
        bool Exists(SaleEditOrders model);
        #endregion
        ...
        int Save(IDbConnection conn, IDbTransaction tran, SaleEditOrders model);
        #endregion
        ...
        /// <param name="model">SaleEditOrders对象</param>
        /// <returns>数据库影响行数</returns>
        int Edit(IDbConnection conn, IDbTransaction tran, SaleEditOrders model);
        #endregion
        ...
        /// <param name="model">SaleEditOrders对象</param>
        /// <returns>数据库影响行数</returns>
        int Delete(SaleEditOrders model);
        #endregion
        ...
        SaleEditOrders GetModel(string iD);
        #endregion
        ...
        PageListBySql<SaleEditOrders> GetPageList(PageListBySql<SaleEditOrders> page, IDictionary<string, object> conditionDict);
        #endregion
    ...
    public partial interface ISaleEditOrdersDAO
    {
        ...
        /// <param name="editId">改单ID</param>
        /// <returns></returns>
        IList<SaleEditOrders> GetList(string editId);
    }
}