/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2015/12/26 9:31:22
 * *******************************************************/
using System;
using System.Linq;
...
namespace Frxs.ServiceCenter.Api.Core
{
    ...
    public class ActionDescriptor : IActionDescriptor, IEquatable<ActionDescriptor>
    {
        ...
        private readonly IList<IAuthentication> _actionAuthenticationBaseAttributes;
        ...
        public ActionDescriptor(IActionDescriptor actionDescriptor)
        {
            ...
            actionDescriptor.ActionType.CheckNullThrowArgumentNullException("actionDescriptor.ActionType");
            ...
            this._actionAuthenticationBaseAttributes = actionDescriptor.Authentications.ToList();
        ...
        /// 接口缓存特性
        /// </summary>
        public ActionResultCacheAttribute Cache { get; private set; }
        ...
        {
            return other != null && this.ActionName.Equals(other.ActionName) && this.Version.Equals(other.Version);
        }
