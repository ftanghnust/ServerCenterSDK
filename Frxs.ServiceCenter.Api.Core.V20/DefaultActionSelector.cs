/*********************************************************
 * FRXS(ISC) zhangliang@frxs.com 2015/12/9 8:41:11
 * *******************************************************/
using System;
...
namespace Frxs.ServiceCenter.Api.Core
{
    ...
    /// 系统默认的Action查找器
    /// </summary>
    public class DefaultActionSelector : IActionSelector, IStartUp
    {
        /// <summary>
        ...
        public DefaultActionSelector(ITypeFinder typeFinder, SystemOptions systemOptions)
        {
            ...
            lock (Locker)
            {
                ...
                this._typeFinder.FindClassesOfType(typeof(IAction))
                    ...
                    .Where(type => type.IsAssignableToActionBase()).OrderBy(o => o.Name).ToList().ForEach(type =>
                    {
                        ...
                        //查询缓存里是否存在了
                        var existsActionDescriptor = CachedActionDescriptors.FirstOrDefault(o =>
                                            o.ActionName.Equals(actionName, StringComparison.OrdinalIgnoreCase)
                                            &&
                                            o.Version == actionDescriptor.Version);
                        ...
                        else
                        {
                            ...
                            throw new ApiException(Resource.CoreResource.DefaultActionSelector_FoundMoreThenOneActionName
        ...
        public ActionDescriptor GetActionDescriptor(string actionName, string version)
        {
            ...
            if (actionDescriptor.IsNull() && this._systemOptions.DefaultActionVersionFailToHighestActionVersion)
            {
