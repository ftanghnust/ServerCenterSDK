/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2016/1/26 17:02:36
 * *******************************************************/
using System;
...
namespace Frxs.ServiceCenter.Api.Core
{
    ...
    internal class DefaultRequestDtoBinder : IRequestDtoBinder
    {
        ...
        public object Bind(RequestContext requestContext, IActionDescriptor actionDescriptor)
        {
            ...
            {
                throw new ApiException("requestDtoType类型必须继承自RequestDtoBase或者实现IRequestDto");
            }
            ...
            try
            {
                ...
                var requestDto = requestContext.DecryptedRequestParams.Data.DeserializeJsonStringToObject(actionDescriptor.RequestDtoType);
