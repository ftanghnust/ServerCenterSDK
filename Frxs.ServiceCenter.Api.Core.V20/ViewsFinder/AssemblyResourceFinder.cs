/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2016/3/29 11:17:51
 * *******************************************************/
using System;
...
namespace Frxs.ServiceCenter.Api.Core
{
    ...
    public class AssemblyResourceFinder : ResourceFinderBase, IStartUp
    {
        ...
        /// </summary>
        private static readonly Dictionary<string, string> CachedManifestResourceNames = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
        ...
        public override IDictionary<string, string> GetResources()
        {
            ...
            lock (Locker)
            {
                ...
                //连接下插件所在程序集
                assemblys = assemblys.Concat(ApiPluginManager.GetApiPlugins().Select(o => o.GetType().Assembly)).ToList();
