/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2015/12/12 10:20:43
 * *******************************************************/
using System;
...
namespace Frxs.ServiceCenter.Api.Core.ViewEngine.Impl
{
    ...
    internal class SectionCollection : List<Section>
    {
        ...
        public string ExtractSource(string[] namespaces)
        {
            ...
            //定义源代码生成的类
            lines.Append("public class Page {" + this._newLine);
        ...
        public void Process(Assembly assembly, ViewParameterCollection parameters, StreamWriter response)
        {
            //程序集为null，直接返回
