/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2015/12/12 9:45:02
 * *******************************************************/
using System;
...
namespace Frxs.ServiceCenter.Api.Core.ViewEngine.Impl
{
    ...
    /// </summary>
    public class ApiViewEngine : IViewEngine
    {
        /// <summary>
        /// 编译源码的语言
        /// </summary>
        ...
        /// </summary>
        private static readonly IDictionary<string, KeyValuePair<SectionCollection, Assembly>> CacheAssemblys = new Dictionary<string, KeyValuePair<SectionCollection, Assembly>>();

        /// <summary>
        /// 默认使用C#语言编译器
        /// </summary>
        public ApiViewEngine() : this(Language.CSharp) { }

        /// <summary>
        /// 指定VIEW视图使用的语言，C#或者VB
        /// </summary>
        /// <param name="language">编译器语言</param>
        private ApiViewEngine(Language language)
        {
        ...
        private void CompileByViewSource(string viewSource, string[] assemblies, string[] namespaces, ViewParameterCollection parameters, StreamWriter response)
        {
            //源码为空，直接抛出异常
        ...
        private void CompileByViewPath(string viewPath, string[] assemblies, string[] namespaces, ViewParameterCollection parameters, StreamWriter response)
        {
            //路径不能为空
