/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2016/4/15 10:21:38
 * *******************************************************/
...
namespace Frxs.ServiceCenter.Api.Core
{
    ...
    public static class ActionConfigCollectionExtensions
    {
        ...
        {
            actionNames.CheckNullThrowArgumentNullException("actionNames");
        ...
        {
            var actionNames = new[] { "Api.Reset", "Api.Cache.Clear", "API.Help", "Api.Index" };
            foreach (var current in actionNames)
            {
                actionConfigCollection.Register(current, new ActionConfigItem() { Obsolete = true });
            }
        ...
        /// <param name="actionConfigCollection">接口配置表对象</param>
        /// <param name="actionName">接口名称，大小写不敏感</param>
        public static IActionConfigCollection RequiredUserIdAndUserName(this IActionConfigCollection actionConfigCollection, string actionName)
        {
            return actionConfigCollection.Register(actionName, new ActionConfigItem() { RequiredUserIdAndUserName = true });
        }
        ...
        /// <param name="version">接口版本，接口版本格式为：1.0</param>
        /// <returns></returns>
        public static IActionConfigCollection RequiredUserIdAndUserName(this IActionConfigCollection actionConfigCollection, string actionName, string version)
        {
            return actionConfigCollection.Register(actionName, version, new ActionConfigItem() { RequiredUserIdAndUserName = true });
        }
