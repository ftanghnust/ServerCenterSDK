/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2016/4/14 14:00:20
 * *******************************************************/
using System;
using System.Linq;
...
namespace Frxs.ServiceCenter.Api.Core
{
    ...
    internal class ActionConfigCollection : Dictionary<string, ActionConfigItem>, IActionConfigCollection
    {
        ...
        /// </summary>
        public readonly ActionConfigItem GlobalActionConfig = new ActionConfigItem()
        {
        ...
        {
            actionName.CheckNullThrowArgumentNullException("actionName");
            value.CheckNullThrowArgumentNullException("value");
        ...
        {
            actionName.CheckNullThrowArgumentNullException("actionName");
            version.CheckNullThrowArgumentNullException("version");
            value.CheckNullThrowArgumentNullException("value");
        ...
        public new ActionConfigItem this[string actionName]
        {
            get
            {
                return this.ContainsKey(actionName)
                    ? base[actionName].MapTo<ActionConfigItem>()
                    : null;
            }
        }
        ...
        {
            //基础配置不能为null
            baseConfig.CheckNullThrowArgumentNullException("baseConfig");
            ...
            foreach (var newConfigProperty in newConfigPropertys)
            {
                ...
                //搜索对应的属性
                var baseProperty = baseConfigPropertys.FirstOrDefault(o => o.Name.Equals(newConfigProperty.Name, StringComparison.OrdinalIgnoreCase));
        ...
        {
            return this.Select(current => new KeyValuePair<string, ActionConfigItem>(current.Key, current.Value.MapTo<ActionConfigItem>()));
        }
    }
}
