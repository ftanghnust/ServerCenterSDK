...
namespace Frxs.ServiceCenter.Api.Core
{
    ...
    public class DefaultIApiDocBuilder : CodeGeneratorBase, IApiDocBuilder
    {
        ...
        protected virtual IList<DefaultValueItemConfig> DefaultValueMapping()
        {
            ...
            mapping.Add(new DefaultValueItemConfig(typeof(string), "http://api.com/imgs/{0}.jpg".With(System.Guid.NewGuid().ToString("N")), "CategoryImage", "PageHomeImage", "ImageUrlOrg", "ImageUrl400x400", "ImageUrl200x200", "ImageUrl120x120", "ImageUrl60x60"));
            ...
            mapping.Add(new DefaultValueItemConfig(typeof(string), "新安路18号芙蓉兴盛总部", "Address"));
            ...
            mapping.Add(new DefaultValueItemConfig(typeof(DateTime), DateTime.Now));
            mapping.Add(new DefaultValueItemConfig(typeof(DateTime?), DateTime.Now));
