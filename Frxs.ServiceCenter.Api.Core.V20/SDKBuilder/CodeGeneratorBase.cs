/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2016/4/12 10:28:08
 * *******************************************************/
using System;
...
namespace Frxs.ServiceCenter.Api.Core
{
    ...
    public abstract class CodeGeneratorBase
    {
        ...
        {
            get { return ActionDocResourceManager.Instance; }
        }
        ...
        public virtual IEnumerable<ComplexObjPropertyTypeDescriptor> GetComplexObjPropertyTypeDescriptors(Type type)
        {
            ...
            //属性描述
            var actionDocResourceManager = ActionDocResourceManager.Instance;
            ...
            return type.GetPropertiesInfo().Select(property => new ComplexObjPropertyTypeDescriptor()
            {
                ...
                Description = actionDocResourceManager.GetDescription("{0}.{1}".With(type.FullName, property.Name)),
