/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 7/13/2016 4:31:36 PM
 * *******************************************************/
using System;
...
namespace Frxs.ServiceCenter.Api.Core
{
    ...
    public interface IObjectMapper
    {
        ...
        /// <returns></returns>
        T MapTo<T>(object sourceObject, bool ignoreCase = true, Expression<Func<T, dynamic>> skipPropertyNames = null);
    }
}
