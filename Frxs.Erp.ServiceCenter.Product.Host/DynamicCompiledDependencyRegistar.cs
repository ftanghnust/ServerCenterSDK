...
namespace Frxs.Erp.ServiceCenter.Product.Host
{
    /// <summary>
    /// 动态注册接口框架配置
        ...
        public void Register()
        {
            ...
            SystemOptionsManager.Current = new SystemOptions()
            {
                ...
                ActionDocResourcePaths = new string[] {
                    System.Web.HttpContext.Current.Server.MapPath("~/Config/Frxs.Erp.ServiceCenter.Product.Host.XML"),
                ...
                //自动输出SDK命名空间
                SdkNamespace = "Frxs.Erp.ServiceCenter.Product.SDK",
