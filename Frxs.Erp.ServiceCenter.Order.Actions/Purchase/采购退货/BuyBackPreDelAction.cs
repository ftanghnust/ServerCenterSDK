...
namespace Frxs.Erp.ServiceCenter.Order.Actions
{
    ...
    /// 采购退货单(待处理)批量删除
    /// </summary>
    [ActionName("BuyBackPre.Del")]
    public class BuyBackPreDelAction : ActionBase<RequestDto.BuyBackPreDelActionRequestDto, int>
    {
        /// <summary>
        /// 执行业务逻辑
        /// </summary>
        ...
        public override ActionResult<int> Execute()
        {
            ...
            var result = BuyBackPreBLO.Delete(requestDto.BackIDs, requestDto.WarehouseId.ToString());
            if (result.IsSuccess)
            {
