...
{
    /// <summary>
    /// BuyOrderPre.AddOrEdit
    /// </summary>
    public class BuyOrderPreAddOrEditActionRequestDto : RequestDtoParent
    {
        ...
        /// </summary>
        [Required]
        public BuyOrderPreRequestDto order { get; set; }

        /// <summary>
        /// 采购收货单详情集合
        /// </summary>
        [Required]
        public IList<BuyOrderPreDetailsRequestDto> orderdetails { get; set; }

        /// <summary>
        /// 采购收货单详情扩展集合
        /// </summary>
        [Required]
        public IList<BuyOrderPreDetailsExtRequestDto> orderdetailsext { get; set; }

        /// <summary>
        /// 采购收货单(待处理)RequestDto
        /// </summary>
        public class BuyOrderPreRequestDto
        {
            /// <summary>
            /// 采购单编号
            /// </summary>
        ...
        /// <summary>
        /// 采购收货单详情(待处理)RequestDto
        /// </summary>
        public class BuyOrderPreDetailsRequestDto
        {
            /// <summary>
            /// 编号（仓库ID+GUID)
            /// </summary>
        ...
        /// <summary>
        /// 采购收货单详情扩展(待处理)RequestDto
        /// </summary>
        public class BuyOrderPreDetailsExtRequestDto
        {
            /// <summary>
    ...
    /// BuyOrderPre.Del
    /// </summary>
    public class BuyOrderPreDelActionRequestDto : RequestDtoParent
    {
        /// <summary>
        /// 采购单编号(批量)
        /// </summary>
    ...
    /// BuyOrderPre.GetList
    /// </summary>
    public class BuyOrderPreGetListActionRequestDto : PageListRequestDto
    {
        /// <summary>
        /// 仓库ID
        /// </summary>
    ...
    /// <summary>
    /// BuyOrderPre.ChangeStatus
    /// </summary>
    public class BuyOrderPreChangeStatusActionRequestDto : RequestDtoParent
    {
    ...
    /// </summary>
    public class BuyOrderPreGetModelActionRequestDto : RequestDtoParent
    {
