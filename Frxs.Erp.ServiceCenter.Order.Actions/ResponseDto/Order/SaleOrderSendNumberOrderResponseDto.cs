...
{
    public class SaleOrderSendNumberLineResponseDto : ResponseDtoBase
    {
        #region 模型
    ...
    public class SaleOrderSendNumberLineListResponseDto : ResponseDtoBase
    {
        /// <summary>
        /// 线路列表
        /// </summary>
        public IList<SaleOrderSendNumberLineResponseDto> SaleOrderSendNumberLineList { get; set; }
    }

    public class SaleOrderSendNumberShopOrderResponseDto : ResponseDtoBase
    {
        /// <summary>
        /// 门店顺序
        /// </summary>
    ...
    public class SaleOrderSendNumberOrderShopListResponseDto : ResponseDtoBase
    {
        public IList<SaleOrderSendNumberShopOrderResponseDto> SaleOrderSendNumberShopList { get; set; }
    }
}
