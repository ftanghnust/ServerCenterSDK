...
namespace Frxs.Erp.ServiceCenter.Order.Actions.ResponseDto
{
    ...
    /// 单个代客订单返回结果
    /// </summary>
    public class SaleOrderPreResponseDto : ResponseDtoBase
    {
        #region 模型
        /// <summary>
        /// 订单编号
    ...
    /// 商品明细
    /// </summary>
    public class SaleOrderPreDetailRequestDto : ResponseDtoBase
    {
        #region 模型
        /// <summary>
        /// 编号(仓库ID+GUID)
    ...
    /// 商品明细扩展
    /// </summary>
    public class SaleOrderPreDetailExtsRequestDto : ResponseDtoBase
    {
        #region 模型
        /// <summary>
