...
{
    public class WProductAddPercMap : EntityTypeConfigurationMapBase<WProductAddPerc>
    {
        public WProductAddPercMap()
        {
            // Primary Key
            this.HasKey(t => t.PercID);
