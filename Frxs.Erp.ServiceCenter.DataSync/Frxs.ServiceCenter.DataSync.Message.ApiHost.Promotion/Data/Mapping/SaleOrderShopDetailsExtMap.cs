...
{
    public class SaleOrderShopDetailsExtMap : EntityTypeConfigurationMapBase<SaleOrderShopDetailsExt>
    {
        public SaleOrderShopDetailsExtMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("SaleOrderShopDetailsExt");
