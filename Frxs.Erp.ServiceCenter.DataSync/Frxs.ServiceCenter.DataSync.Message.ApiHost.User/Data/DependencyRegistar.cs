...
namespace Frxs.ServiceCenter.DataSync.Message.ApiHost.User.Data
{
    /// <summary>
    ...
    public class DependencyRegistar : IDependencyRegistar
    {
        ...
        public void Register(Autofac.ContainerBuilder containerBuilder, ITypeFinder typeFinder, SystemOptions systemOptions)
        {
            ...
            containerBuilder.Register<IDbContext>(c => new UserContext(() => c.Resolve<SysConfig>().ConnectionStringName))
                .InstancePerLifetimeScope();
        }
