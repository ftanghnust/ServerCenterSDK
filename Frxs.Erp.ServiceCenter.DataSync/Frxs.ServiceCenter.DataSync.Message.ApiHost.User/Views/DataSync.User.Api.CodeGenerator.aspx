...
<%@ Assembly Name="Frxs.ServiceCenter.DataSync.Message.ApiHost.User" %>
...
<%@ Import Namespace="Frxs.ServiceCenter.DataSync.Message.ApiHost.User" %>
<%@ Import Namespace="Frxs.ServiceCenter.DataSync.Message.ApiHost.User.Actions" %>
