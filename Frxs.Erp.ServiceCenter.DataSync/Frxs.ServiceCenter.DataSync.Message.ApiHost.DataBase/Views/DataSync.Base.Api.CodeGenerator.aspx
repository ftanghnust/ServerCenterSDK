...
<%@ Assembly Name="Frxs.ServiceCenter.DataSync.Message.ApiHost.DataBase" %>
...
<%@ Import Namespace="Frxs.ServiceCenter.DataSync.Message.ApiHost.DataBase" %>
<%@ Import Namespace="Frxs.ServiceCenter.DataSync.Message.ApiHost.DataBase.Actions" %>
...
namespace Frxs.ServiceCenter.DataSync.Message.ApiHost.DataBase.Actions
{
       ...
       ActionBase<<%:item.Name %>GetAction.<%:item.Name %>GetActionRequestDto, Models.<%:item.Name %>>
    {
        ...
        /// 上送的参数对象
        /// </summary>
        public class <%:item.Name %>GetActionRequestDto : RequestDtoBase
        {
            <%
                foreach (var p in keyMembers) {
...
<!--NewLine-->
            ...
            {
                query = query.Where(o => o.<%:wid.Name %> == this.RequestDto.WID.Value); 
            }
            <%} %>
