...
{
    public class PreBuyOrderMap : EntityTypeConfiguration<PreBuyOrder>
    {
        public PreBuyOrderMap()
        {
            // Primary Key
            this.HasKey(t => t.PreBuyID);
            ...
            this.Property(t => t.Sett_ID)
                .HasMaxLength(50);

            this.Property(t => t.Ref_BuyID)
                .HasMaxLength(36);

            // Table & Column Mappings
            this.ToTable("PreBuyOrder");
            ...
            this.Property(t => t.Sett_ID).HasColumnName("Sett_ID");
            this.Property(t => t.Sett_Date).HasColumnName("Sett_Date");
            this.Property(t => t.Sett_Flag).HasColumnName("Sett_Flag");
            this.Property(t => t.Ref_BuyID).HasColumnName("Ref_BuyID");
        }
    }
}
