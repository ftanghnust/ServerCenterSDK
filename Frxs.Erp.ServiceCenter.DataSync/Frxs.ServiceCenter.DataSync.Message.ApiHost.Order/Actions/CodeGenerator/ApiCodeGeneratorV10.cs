...
namespace Frxs.ServiceCenter.DataSync.Message.ApiHost.Order.Actions
{
    ...
    public class ApiCodeGeneratorV10 : ActionBase<SystemRequestDtoBase, object>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ActionResult<object> Execute()
        {
            ...
            //请求的内部接口
            string actionName = "DataSync.Order.Api.CodeGenerator";
            ...
            foreach (var item in containers.SelectMany(c => c.BaseEntitySets))
            {
                ...
                //输出到文件
                const string htmlSaveDirectory = "~/Actions/System";
                using (var streamWriter = new StreamWriter(this.RequestContext.HttpContext.Server
                    .MapPath("{0}/{1}.cs".With(htmlSaveDirectory, item.Name))))
                {
