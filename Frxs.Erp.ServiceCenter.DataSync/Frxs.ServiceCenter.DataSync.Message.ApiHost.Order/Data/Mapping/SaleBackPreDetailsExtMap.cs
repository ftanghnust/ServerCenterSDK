...
{
    public class SaleBackPreDetailsExtMap : EntityTypeConfigurationMapBase<SaleBackPreDetailsExt>
    {
        public SaleBackPreDetailsExtMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("SaleBackPreDetailsExt");
