...
{
    public class BuyOrderPreDetailsExtMap : EntityTypeConfigurationMapBase<BuyOrderPreDetailsExt>
    {
        public BuyOrderPreDetailsExtMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("BuyOrderPreDetailsExt");
