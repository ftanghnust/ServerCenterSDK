...
{
    public class SaleOrderPreDetailsExtMap : EntityTypeConfigurationMapBase<SaleOrderPreDetailsExt>
    {
        public SaleOrderPreDetailsExtMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("SaleOrderPreDetailsExt");
