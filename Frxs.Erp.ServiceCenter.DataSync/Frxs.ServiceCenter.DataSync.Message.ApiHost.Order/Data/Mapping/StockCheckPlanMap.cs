...
{
    public class StockCheckPlanMap : EntityTypeConfigurationMapBase<StockCheckPlan>
    {
        public StockCheckPlanMap()
        {
            // Primary Key
            ...
            this.Property(t => t.IsLockStock).HasColumnName("IsLockStock");
            this.Property(t => t.LockStockTime).HasColumnName("LockStockTime");
