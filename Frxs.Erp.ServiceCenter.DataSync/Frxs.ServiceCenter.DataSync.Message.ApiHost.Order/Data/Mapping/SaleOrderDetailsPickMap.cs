...
{
    public class SaleOrderDetailsPickMap : EntityTypeConfigurationMapBase<SaleOrderDetailsPick>
    {
        public SaleOrderDetailsPickMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("SaleOrderDetailsPick");
