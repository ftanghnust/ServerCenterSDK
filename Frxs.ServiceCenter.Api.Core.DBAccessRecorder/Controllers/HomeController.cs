/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2016/3/31 10:19:09
 * *******************************************************/
using System;
...
namespace Frxs.ServiceCenter.Api.Core.AccessRecorder.Controllers
{
    /// <summary>
    ...
    public class HomeController : Controller
    {
        ...
        {
            return Redirect(this.RedirectTo("API.Logs.List", "View", new { }.SerializeObjectToJosn(), string.Empty));
        }
        ...
        public System.Web.Mvc.ActionResult Search(string apiname, string ip, int? usedTime)
        {
            return Redirect(this.RedirectTo("API.Logs.List", "View", new
            {
                ...
                ip = ip,
                UsedTime = usedTime
            }.SerializeObjectToJosn(), string.Empty));
        }
