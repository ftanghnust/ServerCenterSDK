...
namespace Frxs.Erp.ServiceCenter.Product.Actions.ResponseDto.Shop
{
    ...
    /// 获取 仓库后台 门店查询列表结果
    /// </summary>
    [ActionName("Shop.Warehouse.TableList")]
    public class ShopWhTableListAction : ActionBase<ShopWhTableListRequestDto, ActionResultPagerData<Model.Shop>>
    {
        ...
        public override ActionResult<ActionResultPagerData<Model.Shop>> Execute()
        {
            ...
            PageListBySql<Model.Shop> models = ShopBLO.GetWhPageList(page, requestDtoDict);
