...
namespace Frxs.Erp.ServiceCenter.Product.Actions.ResponseDto
{
    ...
    /// 
    /// </summary>
    [ActionName("WarehouseEmpShelf.TableList")]
    public class WarehouseEmpShelfTableListAction : ActionBase<RequestDto.WarehouseEmpShelfTableListRequest, ActionResultPagerData<Model.WarehouseEmp>>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override ActionResult<ActionResultPagerData<Model.WarehouseEmp>> Execute()
        {
            ...
            PageListBySql<Model.WarehouseEmp> models = WarehouseEmpShelfBLO.GetPageList(page, requestDtoDict);
