...
{
    /// <summary>
    /// ### BuyBackPreDetailsExt数据库访问类
    /// </summary>
    public partial class BuyBackPreDetailsExtDAO : BaseDAL, IBuyBackPreDetailsExtDAO
    {
        /// <summary>
        /// 无参构造函数
        /// </summary>
        public BuyBackPreDetailsExtDAO() { }
        /// <summary>
        /// 有参构造函数
        /// </summary>
        /// <param name="warehouseId">仓库ID</param>
        public BuyBackPreDetailsExtDAO(string warehouseId)
            : base(warehouseId)
        {
        }

        const string tableName = "BuyBackPreDetailsExt";
        ...
        public bool Exists(BuyBackPreDetailsExt model)
        {
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                new NormalLog
                {
                    ...
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.Exists",
        ...
        public int Save(BuyBackPreDetailsExt model, IDbConnection conn, IDbTransaction tran)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.Save",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">BuyBackPreDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Edit(BuyBackPreDetailsExt model)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
...
new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.Edit",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">BuyBackPreDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Delete(BuyBackPreDetailsExt model)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.Delete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.LogicDelete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public BuyBackPreDetailsExt GetModel(IDictionary<string, object> conditionDict)
        {
            BuyBackPreDetailsExt model = null;
            try
            {
                ...
                IList<BuyBackPreDetailsExt> list = GetList(where.ToString(), sp);
        ...
        /// <param name="iD">编号(BuyBackDetails.ID)</param>
        /// <returns>BuyBackPreDetailsExt对象</returns>
        public BuyBackPreDetailsExt GetModel(string iD)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            BuyBackPreDetailsExt model = null;
            try
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql, sp) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        model = new BuyBackPreDetailsExt
                        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.GetModel",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public IList<BuyBackPreDetailsExt> GetList(IDictionary<string, object> conditionDict)
        {
            IList<BuyBackPreDetailsExt> list = null;
            try
            {
                SqlParameter[] sp = SqlParameterHelper.CreateParameters(conditionDict);
                StringBuilder where = new StringBuilder();
        ...
        public DataSet GetDataSet(IDictionary<string, object> conditionDict, string sqlConfigName)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.GetDataSet",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public PageListBySql<BuyBackPreDetailsExt> GetPageList(PageListBySql<BuyBackPreDetailsExt> page, IDictionary<string, object> conditionDict)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int totalRecords = 0;
            int totalPages = 1;
            try
            {
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql, page.Parameters) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        page.ItemList.Add(new BuyBackPreDetailsExt
                        {
                            ID = DataTypeHelper.GetString(sdr["ID"], null),
                            CategoryId1 = DataTypeHelper.GetInt(sdr["CategoryId1"]),
                            CategoryId1Name = DataTypeHelper.GetString(sdr["CategoryId1Name"], null),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.GetPageList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public int UpdateField(IList<Field> fieldList, IList<WhereCondition> whereConditionList)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.UpdateField",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        #region 根据条件获取BuyBackPreDetailsExt列表   包含历史表数据
        /// <summary>
        /// 根据条件获取BuyBackPreDetailsExt列表
        /// </summary>
        /// <param name="where">条件</param>
        /// <param name="sp">参数数组</param>
        /// <returns>SP对象集合</returns>
        IList<BuyBackPreDetailsExt> GetList(string where, SqlParameter[] sp)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            IList<BuyBackPreDetailsExt> list = new List<BuyBackPreDetailsExt>();
            try
            {
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql.ToString(), sp) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        list.Add(new BuyBackPreDetailsExt
                        {
                            ID = DataTypeHelper.GetString(sdr["ID"], null),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExt.GetList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
    ...
    public partial class BuyBackPreDetailsExtDAO : BaseDAL, IBuyBackPreDetailsExtDAO
    {
        #region 根据BackID批量删除BackOrderPreDetailsExt
        /// <summary>
        ...
        public int Delete(string BackID, IDbConnection conn, IDbTransaction tran)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyBackPreDetailsExtDAO.Delete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        #region 根据条件获取BuyBackPreDetailsExt列表   不含历史表数据
        /// <summary>
        /// 根据条件获取BuyBackPreDetailsExt列表
        /// </summary>
        /// <param name="where">条件</param>
        /// <param name="sp">参数数组</param>
        /// <returns>SP对象集合</returns>
        IList<BuyBackPreDetailsExt> GetListByPre(string where, SqlParameter[] sp)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            IList<BuyBackPreDetailsExt> list = new List<BuyBackPreDetailsExt>();
            try
        ...
        /// <param name="conditionDict">条件参数</param>
        /// <returns>数据集合</returns>
        public IList<BuyBackPreDetailsExt> GetListByPre(IDictionary<string, object> conditionDict)
        {
            IList<BuyBackPreDetailsExt> list = null;
            try
            {
