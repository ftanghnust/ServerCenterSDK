...
{
    /// <summary>
    /// ### BuyOrderDetailsExt数据库访问类
    /// </summary>
    public partial class BuyOrderDetailsExtDAO : BaseDAL, IBuyOrderDetailsExtDAO
    {
        /// <summary>
        /// 无参构造函数
        /// </summary>
        public BuyOrderDetailsExtDAO() { }
        /// <summary>
        /// 有参构造函数
        /// </summary>
        /// <param name="warehouseId">仓库ID</param>
        public BuyOrderDetailsExtDAO(string warehouseId)
            : base(warehouseId)
        {
        }

        const string tableName = "BuyOrderDetailsExt";
        ...
        public bool Exists(BuyOrderDetailsExt model)
        {
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                new NormalLog
                {
                    ...
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.Exists",
        ...
        public int Save(BuyOrderPreDetailsExt model, IDbConnection conn, IDbTransaction tran)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.Save",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">BuyOrderDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Edit(BuyOrderDetailsExt model)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
...
new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.Edit",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">BuyOrderDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Delete(BuyOrderDetailsExt model)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.Delete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.LogicDelete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public BuyOrderDetailsExt GetModel(IDictionary<string, object> conditionDict)
        {
            BuyOrderDetailsExt model = null;
            try
            {
                ...
                IList<BuyOrderDetailsExt> list = GetList(where.ToString(), sp);
        ...
        /// <param name="iD">编号(BuyOrderDetails.ID)</param>
        /// <returns>BuyOrderDetailsExt对象</returns>
        public BuyOrderDetailsExt GetModel(string iD)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            BuyOrderDetailsExt model = null;
            try
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.GetModel",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public IList<BuyOrderDetailsExt> GetList(IDictionary<string, object> conditionDict)
        {
            IList<BuyOrderDetailsExt> list = null;
            try
            {
                SqlParameter[] sp = SqlParameterHelper.CreateParameters(conditionDict);
                StringBuilder where = new StringBuilder();
        ...
        public DataSet GetDataSet(IDictionary<string, object> conditionDict, string sqlConfigName)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.GetDataSet",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public PageListBySql<BuyOrderDetailsExt> GetPageList(PageListBySql<BuyOrderDetailsExt> page, IDictionary<string, object> conditionDict)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int totalRecords = 0;
            int totalPages = 1;
            try
            {
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql, page.Parameters) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        page.ItemList.Add(new BuyOrderDetailsExt
                        {
                            ID = DataTypeHelper.GetString(sdr["ID"], null),
                            CategoryId1 = DataTypeHelper.GetInt(sdr["CategoryId1"]),
                            CategoryId1Name = DataTypeHelper.GetString(sdr["CategoryId1Name"], null),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.GetPageList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public int UpdateField(IList<Field> fieldList, IList<WhereCondition> whereConditionList)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.UpdateField",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        #region 根据条件获取BuyOrderDetailsExt列表
        /// <summary>
        /// 根据条件获取BuyOrderDetailsExt列表
        /// </summary>
        /// <param name="where">条件</param>
        /// <param name="sp">参数数组</param>
        /// <returns>SP对象集合</returns>
        IList<BuyOrderDetailsExt> GetList(string where, SqlParameter[] sp)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            IList<BuyOrderDetailsExt> list = new List<BuyOrderDetailsExt>();
            try
            {
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql.ToString(), sp) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        list.Add(new BuyOrderDetailsExt
                        {
                            ID = DataTypeHelper.GetString(sdr["ID"], null),
                            CategoryId1 = DataTypeHelper.GetInt(sdr["CategoryId1"]),
                            CategoryId1Name = DataTypeHelper.GetString(sdr["CategoryId1Name"], null),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.BuyOrderDetailsExt.GetList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
