...
{
    /// <summary>
    /// ### SaleOrderPreDetailsExt数据库访问类
    /// </summary>
    public partial class SaleOrderPreDetailsExtDAO : BaseDAL, ISaleOrderPreDetailsExtDAO
    {
        public SaleOrderPreDetailsExtDAO(string warehouseId)
            : base(warehouseId)
        {

        }
        const string tableName = "SaleOrderPreDetailsExt";
        ...
        public bool Exists(SaleOrderPreDetailsExt model)
        {
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                new NormalLog
                {
                    ...
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.Exists",
        ...
        public int Save(SaleOrderPreDetailsExt model, IDbConnection conn=null, IDbTransaction tran=null)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
...
new SqlParameter("@ModifyUserName", SqlDbType.VarChar, 32),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.Save",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">SaleOrderPreDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Edit(SaleOrderPreDetailsExt model, IDbConnection conn=null, IDbTransaction tran=null)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
...
new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.Edit",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">SaleOrderPreDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Delete(SaleOrderPreDetailsExt model, IDbConnection conn=null, IDbTransaction tran=null)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.Delete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.LogicDelete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public SaleOrderPreDetailsExt GetModel(IDictionary<string, object> conditionDict)
        {
            SaleOrderPreDetailsExt model = null;
            try
            {
                ...
                IList<SaleOrderPreDetailsExt> list = GetList(where.ToString(), sp);
        ...
        /// <param name="iD">编号(SaleOrderDetails.ID)</param>
        /// <returns>SaleOrderPreDetailsExt对象</returns>
        public SaleOrderPreDetailsExt GetModel(string iD)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            SaleOrderPreDetailsExt model = null;
            try
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql, sp) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        model = new SaleOrderPreDetailsExt
                        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.GetModel",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public IList<SaleOrderPreDetailsExt> GetList(IDictionary<string, object> conditionDict)
        {
            IList<SaleOrderPreDetailsExt> list = null;
            try
            {
                SqlParameter[] sp = SqlParameterHelper.CreateParameters(conditionDict);
                StringBuilder where = new StringBuilder();
        ...
        public DataSet GetDataSet(IDictionary<string, object> conditionDict, string sqlConfigName)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.GetDataSet",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public PageListBySql<SaleOrderPreDetailsExt> GetPageList(PageListBySql<SaleOrderPreDetailsExt> page, IDictionary<string, object> conditionDict)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int totalRecords = 0;
            int totalPages = 1;
            try
            {
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql, page.Parameters) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        page.ItemList.Add(new SaleOrderPreDetailsExt
                        {
                            ID = DataTypeHelper.GetString(sdr["ID"], null),
                            OrderID = DataTypeHelper.GetString(sdr["OrderID"], null),
                            CategoryId1 = DataTypeHelper.GetInt(sdr["CategoryId1"]),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.GetPageList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public int UpdateField(IList<Field> fieldList, IList<WhereCondition> whereConditionList)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.UpdateField",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        #region 根据条件获取SaleOrderPreDetailsExt列表
        /// <summary>
        /// 根据条件获取SaleOrderPreDetailsExt列表
        /// </summary>
        /// <param name="where">条件</param>
        /// <param name="sp">参数数组</param>
        /// <returns>数据集合</returns>
        IList<SaleOrderPreDetailsExt> GetList(string where, SqlParameter[] sp)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            IList<SaleOrderPreDetailsExt> list = new List<SaleOrderPreDetailsExt>();
            try
            {
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql.ToString(), sp) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        list.Add(new SaleOrderPreDetailsExt
                        {
                            ID = DataTypeHelper.GetString(sdr["ID"], null),
                            OrderID = DataTypeHelper.GetString(sdr["OrderID"], null),
                            CategoryId1 = DataTypeHelper.GetInt(sdr["CategoryId1"]),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExt.GetList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
    ...
    public partial class SaleOrderPreDetailsExtDAO : BaseDAL, ISaleOrderPreDetailsExtDAO
    {
        ...
        #region ISaleOrderDetailsExtDAO 成员
        ...
        public int DeleteByOrderId(string orderId, IDbConnection conn=null, IDbTransaction tran=null)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsExtDAO.DeleteByOrderId",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
