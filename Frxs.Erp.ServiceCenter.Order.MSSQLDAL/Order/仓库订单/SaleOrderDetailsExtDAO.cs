...
{
    /// <summary>
    /// ### SaleOrderDetailsExt数据库访问类
    /// </summary>
    public partial class SaleOrderDetailsExtDAO : BaseDAL, ISaleOrderDetailsExtDAO
    {
        /// <summary>
        /// 无参构造函数
        /// </summary>
        public SaleOrderDetailsExtDAO() { }
        /// <summary>
        /// 有参构造函数
        /// </summary>
        /// <param name="warehouseId">仓库ID</param>
        public SaleOrderDetailsExtDAO(string warehouseId)
            : base(warehouseId)
        {
        }


        const string tableName = "SaleOrderDetailsExt";
        /// <summary>
        /// 数据表名
        /// </summary>
        ...
        public bool Exists(SaleOrderDetailsExt model)
        {
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                new NormalLog
                {
                    ...
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderDetailsExt.Exists",
        ...
        public int Save(SaleOrderDetailsExt model)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
...
new SqlParameter("@ModifyUserName", SqlDbType.VarChar, 32)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderDetailsExt.Save",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">SaleOrderDetailsExt对象</param>
        /// <returns>主键自增则返回最新标识列，否则则返回数据库影响行数</returns>
        public int Save(IDbConnection conn, IDbTransaction tran, SaleOrderDetailsExt model)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
            string sql = SQLConfigBuilder.GetSQLScriptByTable(tableName, "Save", base.AssemblyName, base.DatabaseName);
...
new SqlParameter("@ModifyUserName", SqlDbType.VarChar, 32)
        ...
        public int Edit(SaleOrderDetailsExt model)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
...
new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderDetailsExt.Edit",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">SaleOrderDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Edit(IDbConnection conn, IDbTransaction tran, SaleOrderDetailsExt model)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
            string sql = SQLConfigBuilder.GetSQLScriptByTable(tableName, "Edit", base.AssemblyName, base.DatabaseName);
...
new SqlParameter("@ID", SqlDbType.VarChar, 50)
        ...
        /// <param name="model">SaleOrderDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Delete(SaleOrderDetailsExt model)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderDetailsExt.Delete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderDetailsExt.LogicDelete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public SaleOrderDetailsExt GetModel(string iD)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            SaleOrderDetailsExt model = null;
            try
            {
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
                ...
                {
                    model = DataReaderHelper.ExecuteToEntity<SaleOrderDetailsExt>(sdr);
                }
            }
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderDetailsExt.GetModel",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public DataSet GetDataSet(IDictionary<string, object> conditionDict, string sqlConfigName)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderDetailsExt.GetDataSet",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public PageListBySql<SaleOrderDetailsExt> GetPageList(PageListBySql<SaleOrderDetailsExt> page, IDictionary<string, object> conditionDict)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int totalRecords = 0;
            int totalPages = 1;
            try
            {
                ...
                {
                    page.ItemList = DataReaderHelper.ExecuteToList<SaleOrderDetailsExt>(sdr);
                }
            }
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderDetailsExt.GetPageList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        #region 根据条件获取SaleOrderDetailsExt列表
        /// <summary>
        /// 根据条件获取SaleOrderDetailsExt列表
        /// </summary>
        /// <param name="where">条件</param>
        /// <param name="sp">参数数组</param>
        /// <returns>数据集合</returns>
        IList<SaleOrderDetailsExt> GetList(string where, SqlParameter[] sp)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            IList<SaleOrderDetailsExt> list = new List<SaleOrderDetailsExt>();
            try
            {
                ...
                {
                    list = DataReaderHelper.ExecuteToList<SaleOrderDetailsExt>(sdr);
                }
            }
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderDetailsExt.GetList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="conditionDict">条件参数</param>
        /// <returns>数据集合</returns>
        public IList<SaleOrderDetailsExt> GetList(IDictionary<string, object> conditionDict)
        {
            IList<SaleOrderDetailsExt> list = null;
            try
            {
                SqlParameter[] sp = SqlParameterHelper.CreateParameters(conditionDict);
                StringBuilder where = new StringBuilder();
