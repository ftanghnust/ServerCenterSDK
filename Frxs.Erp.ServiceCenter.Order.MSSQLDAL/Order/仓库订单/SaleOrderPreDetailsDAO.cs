...
{
    /// <summary>
    /// ### SaleOrderPreDetails数据库访问类
    /// </summary>
    public partial class SaleOrderPreDetailsDAO : BaseDAL, ISaleOrderPreDetailsDAO
    {
        public SaleOrderPreDetailsDAO(string warehouseId)
            : base(warehouseId)
        {

        }
        const string tableName = "SaleOrderPreDetails";
        ...
        public bool Exists(SaleOrderPreDetails model)
        {
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                new NormalLog
                {
                    ...
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.Exists",
        ...
        public int Save(SaleOrderPreDetails model, IDbConnection conn = null, IDbTransaction tran = null)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
...
new SqlParameter("@ModifyUserName", SqlDbType.VarChar, 32),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.Save",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">SaleOrderPreDetails对象</param>
        /// <returns>数据库影响行数</returns>
        public int Edit(SaleOrderPreDetails model, IDbConnection conn = null, IDbTransaction tran = null)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
...
new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.Edit",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">SaleOrderPreDetails对象</param>
        /// <returns>数据库影响行数</returns>
        public int Delete(SaleOrderPreDetails model, IDbConnection conn = null, IDbTransaction tran = null)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.Delete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.LogicDelete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public SaleOrderPreDetails GetModel(IDictionary<string, object> conditionDict)
        {
            SaleOrderPreDetails model = null;
            try
            {
                ...
                IList<SaleOrderPreDetails> list = GetList(where.ToString(), sp);
        ...
        /// <param name="iD">编号(仓库ID+GUID)</param>
        /// <returns>SaleOrderPreDetails对象</returns>
        public SaleOrderPreDetails GetModel(string iD)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            SaleOrderPreDetails model = null;
            try
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
                ...
                {
                    model = DataReaderHelper.ExecuteToEntity<SaleOrderPreDetails>(sdr);
                }
            }
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.GetModel",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public IList<SaleOrderPreDetails> GetList(IDictionary<string, object> conditionDict)
        {
            IList<SaleOrderPreDetails> list = null;
            try
            {
                SqlParameter[] sp = SqlParameterHelper.CreateParameters(conditionDict);
                StringBuilder where = new StringBuilder();
        ...
        public DataSet GetDataSet(IDictionary<string, object> conditionDict, string sqlConfigName)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.GetDataSet",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public PageListBySql<SaleOrderPreDetails> GetPageList(PageListBySql<SaleOrderPreDetails> page, IDictionary<string, object> conditionDict)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int totalRecords = 0;
            int totalPages = 1;
            try
            {
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql, page.Parameters) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        page.ItemList.Add(new SaleOrderPreDetails
                        {
                            ...
                            SalePackingQty = DataTypeHelper.GetInt(sdr["SalePackingQty"]),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.GetPageList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public int UpdateField(IList<Field> fieldList, IList<WhereCondition> whereConditionList)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.UpdateField",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        #region 根据条件获取SaleOrderPreDetails列表
        /// <summary>
        /// 根据条件获取SaleOrderPreDetails列表
        /// </summary>
        /// <param name="where">条件</param>
        /// <param name="sp">参数数组</param>
        /// <returns>数据集合</returns>
        IList<SaleOrderPreDetails> GetList(string where, SqlParameter[] sp)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            IList<SaleOrderPreDetails> list = new List<SaleOrderPreDetails>();
            try
            {
                ...
                {
                    list = DataReaderHelper.ExecuteToList<SaleOrderPreDetails>(sdr);
                }
            }
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetails.GetList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
            ...
            return list.OrderBy(x => x.SerialNumber).ToList();
        }
        #endregion
    ...
    public partial class SaleOrderPreDetailsDAO : BaseDAL, ISaleOrderPreDetailsDAO
    {
        ...
        public int DeleteByOrderId(string orderId, IDbConnection conn = null, IDbTransaction tran = null)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleOrderPreDetailsDAO.DeleteByOrderId",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="conditionDict">条件参数</param>
        /// <returns>数据集合</returns>
        public IList<SaleOrderPreDetails> GetList(IDbConnection conn, IDbTransaction tran, IDictionary<string, object> conditionDict)
        {
            IList<SaleOrderPreDetails> list = null;
            try
            {
                ...
                list = GetList(conn, tran, where.ToString(), sp);
            }
            catch
            {
                throw;
        ...
        #region 根据条件获取SaleOrderPreDetails列表(事物)
        /// <summary>
        /// 根据条件获取SaleOrderPreDetails列表(事物)
        /// </summary>
        /// <param name="where">条件</param>
        /// <param name="sp">参数数组</param>
        /// <returns>数据集合</returns>
        IList<SaleOrderPreDetails> GetList(IDbConnection conn, IDbTransaction tran, string where, SqlParameter[] sp)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            IList<SaleOrderPreDetails> list = new List<SaleOrderPreDetails>();
            try
            {
                ...
                DataSet ds = helper.GetDataSet(conn, tran, sql.ToString(), sp);
                if (ds != null && ds.Tables[0].Rows.Count > 0)
                {
                    list = Frxs.Platform.Utility.Map.DataTableConverter.ConvertDataTableToList<SaleOrderPreDetails>(ds.Tables[0]);
                }
            }
            catch (Exception ex)
            {
