...
{
    /// <summary>
    /// ### SaleBackPreDetailsExt数据库访问类
    /// </summary>
    public partial class SaleBackPreDetailsExtDAO : BaseDAL, ISaleBackPreDetailsExtDAO
    {
        /// <summary>
        /// 无参构造函数
        /// </summary>
        public SaleBackPreDetailsExtDAO() { }
        /// <summary>
        /// 有参构造函数
        /// </summary>
        /// <param name="warehouseId">仓库ID</param>
        public SaleBackPreDetailsExtDAO(string warehouseId)
            : base(warehouseId)
        {
        }

        const string tableName = "SaleBackPreDetailsExt";
        ...
        public bool Exists(SaleBackPreDetailsExt model)
        {
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                new NormalLog
                {
                    ...
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.Exists",
        ...
        public int Save(SaleBackPreDetailsExt model, IDbConnection conn, IDbTransaction tran)
        {
           DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.Save",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">SaleBackPreDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Edit(SaleBackPreDetailsExt model)
        {
           DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
...
new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.Edit",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        /// <param name="model">SaleBackPreDetailsExt对象</param>
        /// <returns>数据库影响行数</returns>
        public int Delete(SaleBackPreDetailsExt model)
        {
           DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int result = 0;
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.Delete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.LogicDelete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public SaleBackPreDetailsExt GetModel(IDictionary<string, object> conditionDict)
        {
            SaleBackPreDetailsExt model = null;
            try
            {
                ...
                IList<SaleBackPreDetailsExt> list = GetList(where.ToString(), sp);
        ...
        /// <param name="iD">编号(SaleBackDetails.ID)</param>
        /// <returns>SaleBackPreDetailsExt对象</returns>
        public SaleBackPreDetailsExt GetModel(string iD)
        {
           DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            SaleBackPreDetailsExt model = null;
            try
 ...
 new SqlParameter("@ID", SqlDbType.VarChar, 50)
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql, sp) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        model = new SaleBackPreDetailsExt
                        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.GetModel",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public IList<SaleBackPreDetailsExt> GetList(IDictionary<string, object> conditionDict)
        {
            IList<SaleBackPreDetailsExt> list = null;
            try
            {
                SqlParameter[] sp = SqlParameterHelper.CreateParameters(conditionDict);
                StringBuilder where = new StringBuilder();
        ...
        public DataSet GetDataSet(IDictionary<string, object> conditionDict, string sqlConfigName)
        {
           DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.GetDataSet",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public PageListBySql<SaleBackPreDetailsExt> GetPageList(PageListBySql<SaleBackPreDetailsExt> page, IDictionary<string, object> conditionDict)
        {
           DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            int totalRecords = 0;
            int totalPages = 1;
            try
            {
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql, page.Parameters) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        page.ItemList.Add(new SaleBackPreDetailsExt
                        {
                            ID = DataTypeHelper.GetString(sdr["ID"], null),
                            CategoryId1 = DataTypeHelper.GetInt(sdr["CategoryId1"]),
                            CategoryId1Name = DataTypeHelper.GetString(sdr["CategoryId1Name"], null),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.GetPageList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        public int UpdateField(IList<Field> fieldList, IList<WhereCondition> whereConditionList)
        {
           DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.UpdateField",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        #region 根据条件获取SaleBackPreDetailsExt列表  包含历史表数据
        /// <summary>
        /// 根据条件获取SaleBackPreDetailsExt列表
        /// </summary>
        /// <param name="where">条件</param>
        /// <param name="sp">参数数组</param>
        /// <returns>SP对象集合</returns>
        IList<SaleBackPreDetailsExt> GetList(string where, SqlParameter[] sp)
        {
           DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            IList<SaleBackPreDetailsExt> list = new List<SaleBackPreDetailsExt>();
            try
            {
                ...
                using (SqlDataReader sdr = helper.GetIDataReader(sql.ToString(), sp) as SqlDataReader)
                {
                    while (sdr.Read())
                    {
                        list.Add(new SaleBackPreDetailsExt
                        {
                            ID = DataTypeHelper.GetString(sdr["ID"], null),
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExt.GetList",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
    ...
    public partial class SaleBackPreDetailsExtDAO : BaseDAL, ISaleBackPreDetailsExtDAO
    {
        #region 根据BackID批量删除SaleBackPreDetailsExt
        /// <summary>
        ...
        public int Delete(string BackID, IDbConnection conn, IDbTransaction tran)
        {
           DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            ...
            catch (Exception ex)
            {
                ...
                {
                    LogSource = helper.DataSource,
                    LogOperation = "Frxs.Erp.ServiceCenter.Order.MSSQLDAL.SaleBackPreDetailsExtDAO.Delete",
                    LogContent = exceptionSql,
                    LogTime = DateTime.Now
                },
                ex
        ...
        #region 根据条件获取SaleBackPreDetailsExt列表  不含历史表数据
        /// <summary>
        /// 根据条件获取SaleBackPreDetailsExt列表
        /// </summary>
        /// <param name="where">条件</param>
        /// <param name="sp">参数数组</param>
        /// <returns>SP对象集合</returns>
        IList<SaleBackPreDetailsExt> GetListByPre(string where, SqlParameter[] sp)
        {
            DBHelper helper = DBHelper.GetInstance(base.ConnectionString);
            IList<SaleBackPreDetailsExt> list = new List<SaleBackPreDetailsExt>();
            try
        ...
        /// <param name="conditionDict">条件参数</param>
        /// <returns>数据集合</returns>
        public IList<SaleBackPreDetailsExt> GetListByPre(IDictionary<string, object> conditionDict)
        {
            IList<SaleBackPreDetailsExt> list = null;
            try
            {
