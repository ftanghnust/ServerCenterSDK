...
{
    /// <summary>
    /// BuyPreAppDetailsExt实体类
    /// </summary>
    [Serializable]
    [DataContract]
    public partial class BuyPreAppDetailsExt : BaseModel
    {

        #region 模型
        /// <summary>
        /// 编号(BuyPreAppDetails.ID)
        /// </summary>
        [DataMember]
        [DisplayName("编号(BuyPreAppDetails.ID)")]
        [Required(ErrorMessage = "{0}不能为空")]
        public string ID { get; set; }

        /// <summary>
        /// 采购单编号(BuyPreApp.AppID)
        /// </summary>
        [DataMember]
        [DisplayName("采购单编号(BuyPreApp.AppID)")]
        [Required(ErrorMessage = "{0}不能为空")]
