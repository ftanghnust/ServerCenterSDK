...
namespace Frxs.Erp.ServiceCenter.Member.MSSQLDAL
{
    public abstract class BaseDAL
    {
        ...
        public string ConnectionString
        {
            get
            {
                return System.Configuration.ConfigurationManager.ConnectionStrings["conn"].ToString();
            }
        }
            ...
            catch (Exception ex)
            {
                ...
                (
                    new NormalLog
                    {
                        ...
                        LogOperation = "Frxs.Erp.ServiceCenter.Member.MSSQLDAL.BaseDAL.ExecuteToEntity",
        ...
        protected IList<T> ExecuteTolist<T>(string xmlConfigSqlName, SqlParameter[] sqlParameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                (
                    ...
                    {
                        LogSource = helper.DataSource,
                        LogOperation = "Frxs.Erp.ServiceCenter.Member.MSSQLDAL.BaseDAL.ExecuteTolist",
                        LogContent = exceptionSql,
                        LogTime = DateTime.Now
                    },
                    ex
        ...
        protected object ExecuteToSingle(string xmlConfigSqlName, SqlParameter[] sqlParameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                (
                    ...
                    {
                        LogSource = helper.DataSource,
                        LogOperation = "Frxs.Erp.ServiceCenter.Member.MSSQLDAL.BaseDAL.ExecuteToSingle",
                        LogContent = exceptionSql,
                        LogTime = DateTime.Now
                    },
                    ex
