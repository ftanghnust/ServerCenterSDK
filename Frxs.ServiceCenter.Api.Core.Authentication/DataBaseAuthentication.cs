/*********************************************************
 * FRXS(ISC) zhangliang4629@163.com 2015/11/25 11:52:01
 * *******************************************************/
using System.Linq;
using Frxs.ServiceCenter.Api.Core;

namespace Frxs.ServiceCenter.Product.Api.Authentication
{
    /// <summary>
    /// 将APPKEY保持在了数据库里进行校验；只要实现IsValid方法就可以了
    /// </summary>
    public class DataBaseAuthentication : DefaultAuthentication
    {
        /// <summary>
        /// 数据签名
        /// </summary>
        ...
        {
            //接口名称未提交
            if (requestContext.DecryptedRequestParams.ActionName.IsNullOrEmpty())
            {
                return false;
            }

            // return requestContext.ClientRequestParams.Sign == Sign(n;
            return true;
        }
