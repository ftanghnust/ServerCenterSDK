...
-->
<%@ Page Language="C#" %>
<%@ Assembly Name="Frxs.ServiceCenter.Api.Core.ApiTestTool" %>
...
<%@ Import Namespace="Frxs.ServiceCenter.Api.Core.ApiTestTool" %>
...
<head>
    ...
    <title>API接口调试插件，基于接口框架：<%:Frxs.ServiceCenter.Api.Core.ApiVersion.Version %></title>
