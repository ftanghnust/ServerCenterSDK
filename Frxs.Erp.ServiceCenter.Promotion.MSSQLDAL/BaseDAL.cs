...
namespace Frxs.Erp.ServiceCenter.Promotion.MSSQLDAL
{
    public abstract class BaseDAL
    {
        ...
        public BaseDAL(string warehouseId)
        {
            ...
            {
                //获以基础库数据数据字符串
                //this.ConnectionString = DBConfigHelper.GetConnectionString(DBConfigHelper.PROMOTIONDB_HEADER + this.WarehouseId);
        ...
        protected string GetMultiConnectionString(string conKey)
        {
            ...
            conKey = string.Format("{0}{1}", ConstDefinition.PROMOTIONDB_HEADER, conKey);
